...
namespace Modelo
{
    ...
    public class ObtenerTablaInteresCorrienteCSV : ObtenerTablaCSV
	{
        ...
        {
            StreamReader reader = new StreamReader(File.OpenRead(ConfigurationManager.AppSettings["tablaInteresCorrienteCSV-Path"]));
            return reader;
        }
